...
void setPortConfig() {
    ...
    // IOCAbits.IOCA0          = ENABLE;        // interrupt-on-change  [1=enabled 0=disabled]
        ...
        // - PIN RA1 come RAIE
        // ------------------------------
    TRISAbits.TRISA1        = INPUT;         // 1=set as input
    WPUDAbits.WPUDA1        = ENABLE;        // Pull-UP/Down         [1=enabled 0=disabled]
    WDAbits.WDA1            = PULLUP;        // Pull-UP/Down direction (1=PullUP 0=PullDOWN)
    IOCAbits.IOCA1          = ENABLE;        // interrupt-on-change  [1=enabled 0=disabled]

        // ------------------------------
        // - PIN RA2 come INT0
        // ------------------------------
    TRISAbits.TRISA2        = INPUT;        // 1=set as input
    WPUDAbits.WPUDA2        = ENABLE;        // Pull-UP/Down         [1=enabled 0=disabled]
    WDAbits.WDA2            = PULLUP;        // Pull-UP/Down direction (1=PullUP 0=PullDOWN)
    IOCAbits.IOCA2          = ENABLE;        // interrupt-on-change  [1=enabled 0=disabled]


        // ------------------------------
        // - PIN RA4 come ALARM_PIN
        // ------------------------------
    TRISAbits.TRISA4        = OUTPUT;        // 1=set as input


        // ------------------------------
        // - PIN RA4 come LED_PIN
        // ------------------------------
    TRISAbits.TRISA5        = OUTPUT;        // 1=set as input
...
void setMainConfig() {
    ...
    OPTION_REG    =  0b10000111;             // 1=INPUT - 0=OUTPUT
